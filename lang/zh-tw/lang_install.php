...
return array(
    ...
    'license_title' => 'WellCMS 2.2 版授權協議',
	'license_content' => '感謝您選擇 WellCMS 2.2，它是一款傾向移動端的內容管理產品，前後台支持移動端各種操作。 WellCMS 具有安全、高效、穩定、速度快、負載超強的特點，尤其在大數據量下，它的優秀才更顯卓越。
<br><br>
WellCMS 2.2 自適應手機、平板、PC，也可設置單獨加載各端模板，並且URL保持不變，有著非常方便的插件和模板開發機制。前台部分頁面配備API，可通過JSON返回AJAX請求的數據，方便 APP 開發。
<br><br>
WellCMS 2.2 只有 22 張表，源代碼壓縮後 1M 左右，運行速度非常快，處理單次請求在 0.01 秒級別。前後端代碼分離，支持各種 NoSQL 操作、支持整站附件分離，支持一主多從讀寫分離。分佈式服務器設計，每張表都可創建單獨的 DB 服務器群和 CACHE 服務器群，單表可承載億級以上數據，方便部署和維護，是一個二次開發非常好的基石。
<br><br>
採用 Bootstrap 4 + JQuery 3 作為前端類庫，全面支持移動端瀏覽器；後端基於 PHP7 MySQL，支持XCache/Yac/Redis/Memcached等 NoSQL 的方式操作各種數據庫。
<br><br>
WellCMS 2.2 採用 MIT 協議發布，您可以自由修改、派生版本、商用而不用擔心任何法律風險（修改後應保留原來的版權信息）。
<br><br>
