...
return array(
    ...
    'plugin_download_successfully' => '下載插件 ({dir}) 成功,請點擊進行安裝',
    ...
    'other_function' => '其他功能',
    'system_setting' => '系統設置',
    'upgrading' => '正在陞級,請勿刷新頁面&nbsp;&nbsp;<i class="icon icon-refresh icon-spin"></i>',
    'online_upgrade' => '線上升級',
    'upgrade_failed' => '陞級失敗',
    'current_version' => '當前版本',
    'official_version' => '官方版本',
    'no_upgrade_required' => '無需陞級',
    'upgrade_successfully' => '陞級成功',
    'admin_access' => '後臺許可權',
    'in_to_admin' => '進入後臺',
    'manage_content' => '管理內容',
