...
<br><br>
WellCMS 2.0 is released under the MIT agreement. You can freely modify, derive the version, and use it commercially without worrying about any legal risks (the original copyright information should be retained after the modification).',
    'license_date' => 'Release date: January 6, 2020',
    'agree_license_to_continue' => 'Agree to continue to install the agreement',
    'install_title' => 'WellCMS 2.0 Installation wizard',
